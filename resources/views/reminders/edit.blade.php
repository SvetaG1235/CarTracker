    ...
    <div class="row g-3">
        ...
        <div class="col-md-6">
            ...
            <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" 
                   value="{{ old('title', $reminder->title) }}" placeholder="Например: Замена воздушного фильтра" required>
        ...
        <div class="col-md-6">
            ...
            <input type="date" name="due_date" id="due_date" class="form-control @error('due_date') is-invalid @enderror" 
                   value="{{ old('due_date', $reminder->due_date?->format('Y-m-d')) }}" required>
        ...
        <div class="col-12 mt-3 p-3 rounded border" id="mileageBlock" style="display: none; background: var(--app-light);">
            ...
            <div class="form-check form-switch">
                <input class="form-check-input" type="checkbox" name="is_mileage_based" value="1" id="mileageToggle" 
                       {{ old('is_mileage_based', $reminder->is_mileage_based) ? 'checked' : '' }}>
                ...
                <div class="row g-2 mt-2">
                    <div class="col-md-6">
                        ...
                        <input type="number" name="mileage_interval" class="form-control form-control-sm" 
                               value="{{ old('mileage_interval', $reminder->mileage_interval) }}" placeholder="Например: 10000">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label small">Следующий порог</label>
                        <input type="text" class="form-control form-control-sm bg-secondary text-white" id="calcNextMileage" readonly value="{{ $reminder->next_mileage_due ? $reminder->next_mileage_due . ' км' : '—' }}">
                    </div>
                </div>
            </div>
        </div>
