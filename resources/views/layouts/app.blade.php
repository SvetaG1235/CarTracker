...
<head>
    ...
    <style>
        ...
        .badge-makk-success { background: #28a745; color: #fff; }
        .badge-makk-warning { background: #ffc107; color: #000; }
        .badge-makk-danger { background: #dc3545; color: #fff; }
        .badge-makk-secondary { background: var(--makk-gray); color: #fff; }
        /* Логотип */
        .navbar-logo {
            height: 32px;
            width: auto;
